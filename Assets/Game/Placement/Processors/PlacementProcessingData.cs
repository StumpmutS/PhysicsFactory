...
public class PlacementProcessingData
{
    ...
    public PlaceablePreview Preview { get; }
    public List<Restriction<PlacementRestrictionInfo>> PlacementRestrictions;
    public Func<PlacementRestrictionInfo> InfoGetter;

    public PlacementProcessingData(Grid3D grid, PlaceablePreview preview, List<Restriction<PlacementRestrictionInfo>> restrictions, Func<PlacementRestrictionInfo> restrictionInfoGetter)
    {
        Grid = grid;
        Preview = preview;
