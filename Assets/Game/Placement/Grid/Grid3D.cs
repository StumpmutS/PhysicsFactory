...
public class Grid3D : MonoBehaviour
{
    ...
    public static Vector3 ConvertToCellPosition(Vector3 vector3)
    {
        return new Vector3(ConvertToCellPosition(vector3.x), ConvertToCellPosition(vector3.y),
            ConvertToCellPosition(vector3.z));
    }
    
    public static float ConvertToCellPosition(float number)
    {
